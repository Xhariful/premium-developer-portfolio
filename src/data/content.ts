...
export const skillCategories = [
  {
    ...
    title: "Frontend",
    skills: [
      { name: "React / Next.js", level: 98, years: 7 },
      { name: "TypeScript", level: 95, years: 6 },
      { name: "Tailwind CSS", level: 96, years: 5 },
      { name: "Framer Motion", level: 90, years: 4 },
    ],
  },
  {
    id: "backend",
    title: "Backend",
    skills: [
      { name: "Node.js / Express", level: 92, years: 6 },
      { name: "PostgreSQL", level: 88, years: 5 },
      { name: "GraphQL", level: 85, years: 4 },
      { name: "AWS / Cloudflare", level: 82, years: 4 },
    ],
  },
  {
    id: "cms",
    ...
    skills: [
      { name: "Shopify (Liquid)", level: 90, years: 4 },
      { name: "WordPress", level: 88, years: 6 },
      { name: "Sanity / Contentful", level: 84, years: 3 },
    ],
  },
  {
    id: "tools",
    title: "Tools & DevOps",
    skills: [
      { name: "Git / GitHub", level: 96, years: 8 },
      { name: "Docker", level: 80, years: 4 },
      { name: "CI/CD Pipelines", level: 85, years: 4 },
      { name: "Figma", level: 88, years: 5 },
    ],
  },
];
